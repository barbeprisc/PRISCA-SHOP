...
function assign_global(){
	...
	$hill_global['hill_copyright_text'] = 'Proudly powered by WordPress | Theme: hill-shop by gravitymaster97';
	//breadcrumb
	...
	$hill_global['hill_about_sub_heading'] ='';
	$hill_global['hill_about_title'] ='';
	$hill_global['hill_about_sub_title'] ='';
	$hill_global['hill_about_description'] ='';
	...
	$hill_global['hill_team_number'] = [
		[
			...
			'hill_team_facebook_link'=>'#',
			'hill_team_twitter_link'=>'#',
			'hill_team_instagram_link'=>'#',
			'hill_team_linkedin_link'=>'#',
		],
		[
			'hill_team_image'=>'',
			'hill_team_title'=>'',
